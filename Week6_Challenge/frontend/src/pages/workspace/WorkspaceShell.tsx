    ...
    <div className="flex h-screen bg-canvas">
      ...
      >
        ...
        <div className="space-y-0.5 border-b border-line p-2">
          ...
          <NavLink
            to={`/workspaces/${workspaceId}/quality-dashboard`}
            className={navLinkClass}
            onClick={() => setIsSidebarOpen(false)}
          >
            Quality dashboard
          </NavLink>
          <NavLink to={`/workspaces/${workspaceId}/traces`} className={navLinkClass} onClick={() => setIsSidebarOpen(false)}>
            Traces
          </NavLink>
          <NavLink to={`/workspaces/${workspaceId}/guardrails`} className={navLinkClass} onClick={() => setIsSidebarOpen(false)}>
            Guardrails
          </NavLink>
        </div>
